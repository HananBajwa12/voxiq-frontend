...
function injectPricing(filePath) {
  ...
  // Find the block starting with `<div style={{ display: 'grid', ... className="pricing-grid">`
  let startIndex = content.indexOf('<div style={{\n            display: \'grid\',\n            gridTemplateColumns: \'repeat(3, 1fr)\',');
  if (startIndex === -1) {
    startIndex = content.indexOf('<div style={{\r\n            display: \'grid\',\r\n            gridTemplateColumns: \'repeat(3, 1fr)\',');
  }
