            ...
            {[
              {
                ...
                calc: billingCycle === 'annual' ? '$19.99/seat/mo × 1 seat' : '$24.99/seat/mo × 1 seat',
                dot: '#3b82f6',
                popular: false,
              ...
              },
              {
                ...
                calc: billingCycle === 'annual' ? '$31.99/seat/mo × 1 seat' : '$39.99/seat/mo × 1 seat',
                dot: '#8b5cf6',
                popular: true,
                buttonText: 'Start Free Trial',
                features: [
              ...
              },
              {
                ...
                calc: billingCycle === 'annual' ? '$55.99/seat/mo × 1 seat' : '$69.99/seat/mo × 1 seat',
                dot: '#f59e0b',
                popular: false,
                buttonText: 'Start Free Trial',
                features: [
                    ...
                    <div style={{ 
                      ...
                      {plan.price === 'Talk to Sales' ? (
                        ...
                        <>
                          ...
                          <span style={{ fontSize: '0.9rem', color: isPopular ? 'rgba(127,205,255,0.7)' : '#6B9AB8', fontWeight: 500, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>/mo</span>
                        </>
                      )}
                    </div>
                    {plan.calc ? (
                    ...
                    {plan.price !== 'Talk to Sales' ? (
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: isPopular ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.02)', padding: '6px 12px', borderRadius: '8px', marginBottom: '24px' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: isPopular ? 'rgba(255,255,255,0.1)' : 'rgba(255,255,255,0.05)', padding: '4px 8px', borderRadius: '6px', border: isPopular ? '1px solid rgba(255,255,255,0.2)' : '1px solid rgba(255,255,255,0.1)' }}>
                          <span style={{ fontSize: '1rem', cursor: 'pointer', color: '#F1F5F9' }}>-</span>
                          <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#F1F5F9' }}>1</span>
                          <span style={{ fontSize: '1rem', cursor: 'pointer', color: '#F1F5F9' }}>+</span>
                        </div>
                      </div>
                    ) : (
