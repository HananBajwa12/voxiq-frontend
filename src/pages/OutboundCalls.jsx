...
export default function OutboundCalls() {
  ...
  return (
    <div style={{ background: C.midnight, minHeight: '100vh', overflowX: 'hidden', fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
        ...
        <div style={{ ...wrap, position: 'relative', zIndex: 10, width: '100%' }}>
          <div style={{ display: 'grid', gridTemplateColumns: mobile ? '1fr' : '55% 45%', gap: '48px', alignItems: 'center' }}>
            ...
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.p variants={fadeUp} style={{ fontSize: '1.05rem', color: C.foam, lineHeight: 1.78, maxWidth: '460px', margin: '0 0 32px' }}>
      ...
      {/* ══ CTA — ocean gradient ══ */}
      <section style={{ background: `linear-gradient(135deg,${C.oceanDeep},${C.oceanMid},${C.oceanDeep})`, paddingTop: '88px', paddingBottom: '160px', textAlign: 'center' }}>
        <div style={wrap}>
          <Reveal>
