            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '80px' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h4 style={{ margin: '0 0 12px 0', fontSize: '0.9rem', color: C.breeze }}>Channel Diagnostics</h4>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h4 style={{ margin: '0 0 12px 0', fontSize: '0.9rem', color: C.breeze }}>Sequence Flow</h4>
      ...
      <section style={{ padding: '60px 0', background: C.white, borderTop: '1px solid rgba(10,37,64,.07)' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }} className="related-grid">
            {[
              { name: 'SMS', path: '/features/sms', color: C.breeze },
