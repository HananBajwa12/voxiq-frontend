          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '60px', alignItems: 'center' }} className="hero-grid-solutions">
            <div>
              ...
              <h1 style={{
                ...
                Give your sales team a dialer that keeps up with quota.
              </h1>
              ...
              <p style={{
                ...
                Voxiq powers every stage of the sales cycle — prospecting, follow-up, and closing — with the speed and visibility your team needs to hit number.
              </p>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: '1px solid #1e2537', paddingBottom: '12px' }}>
                <span style={{ fontSize: '13px', fontWeight: 600, color: '#6B9AB8' }}>Sales Team Activity</span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: '#020D1A', border: '1px solid #1e2537', borderRadius: '6px', fontSize: '13px' }}>
                  <span>Deals worked today</span>
                  <span style={{ color: '#7FCDFF', fontWeight: 600 }}>38</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: '#020D1A', border: '1px solid #1e2537', borderRadius: '6px', fontSize: '13px' }}>
                  <span>Avg follow-up time</span>
                  <span style={{ color: '#10B981', fontWeight: 600 }}>2 min</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section style={{ background: C.breezeLight, padding: '32px 0' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '40px', textAlign: 'center' }} className="stats-row">
            {[
              { val: '3x', desc: 'Faster follow-up on new leads' },
              { val: '190', desc: 'Dials per rep per day' },
              { val: '2x', desc: 'Increase in close rate' }
            ].map((st, i) => (
              <div key={i}>
        ...
        <section style={{ padding: '80px 0', background: C.oceanMid }}>
          <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <h2 style={{ fontSize: '2.25rem', fontWeight: 700, color: C.breezeLight, letterSpacing: '-0.02em' }}>What's slowing your sales team down?</h2>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '30px' }} className="benefits-grid">
              {[
                {
                  title: 'Reps juggling five tools lose deals in the cracks',
                  desc: 'Dialer here, CRM there, notes somewhere else — every context switch is a chance for a lead to go cold.'
                },
                {
                  title: 'Slow follow-up costs deals to faster competitors',
                  desc: 'The rep who calls a lead first wins the deal more often than not. Manual follow-up is too slow to compete.'
                },
                {
                  title: 'Managers can\'t see pipeline health until it\'s too late',
                  desc: 'Without real-time visibility into calls and outcomes, deals slip through the pipeline unnoticed until forecast day.'
                }
              ].map((p, idx) => (
                <div key={idx} style={{
        ...
        <section style={{ padding: '80px 0', background: C.cream }}>
          <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '30px' }} className="benefits-grid">
              {[
                {
                  title: 'Unified Dialer & CRM',
                  desc: 'Call, log, and update the deal without leaving one screen. No more tab-switching between four tools.'
                },
                {
                  title: 'Instant Lead Response',
                  desc: 'New leads route to the next available rep and dial automatically — while interest is still hot.'
                },
                {
                  title: 'Full Pipeline Visibility',
                  desc: 'Managers see every call, every outcome, and every deal stage in real time — not at the end of the week.'
                }
              ].map((s, idx) => (
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="feature-row">
                <div>
                  <h2 style={{ fontSize: '2.25rem', fontWeight: 700, color: C.breezeLight, marginBottom: '20px', lineHeight: '1.2', letterSpacing: '-0.02em' }}>
                    From lead to first call in under a minute
                  </h2>
                  <p style={{ fontSize: '1.1rem', color: 'rgba(127,205,255,.65)', lineHeight: '1.7', marginBottom: '24px' }}>
                    Every new lead routes straight to an available rep and dials automatically. No manual assignment, no waiting for a manager to distribute leads — reps call while the prospect is still thinking about you.
                  </p>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    {[
                      'Automatic lead-to-rep routing',
                      'Instant outbound dial on lead creation',
                      'One-click voicemail drop',
                      'Local presence number selection',
                      'Deal stage updates after every call'
                    ].map((item, idx) => (
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: 'rgba(127,205,255,.04)', border: '1px solid rgba(127,205,255,.08)', borderRadius: '6px', fontSize: '13px', color: C.breezeLight }}>
                      <span>New leads dialed &lt; 60s</span>
                      <span style={{ color: C.breeze, fontWeight: 600 }}>94%</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: 'rgba(127,205,255,.04)', border: '1px solid rgba(127,205,255,.08)', borderRadius: '6px', fontSize: '13px', color: C.breezeLight }}>
                      <span>Deals worked/rep/day</span>
                      <span style={{ color: C.liveGreen, fontWeight: 600 }}>38</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="feature-row">
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px', color: C.breeze, fontSize: '13px', fontWeight: 600 }}>
                    <Users size={16} /> Pipeline Visibility Console
                  </div>
                  <div style={{ background: 'rgba(127,205,255,.04)', border: '1px solid rgba(127,205,255,.08)', borderRadius: '10px', padding: '16px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                      <span style={{ fontSize: '12px', fontWeight: 600, color: C.breezeLight }}>Rep: Maria Chen</span>
                      <span style={{ fontSize: '11px', color: C.breeze, background: 'rgba(127,205,255,.1)', padding: '2px 6px', borderRadius: '4px' }}>On call</span>
                    </div>
                    <div style={{ fontSize: '12px', color: 'rgba(127,205,255,.65)', lineHeight: '1.4' }}>
                      Deal: Acme Corp — Stage: Negotiation — Value: $24,000
                    </div>
                  </div>
                </div>
                <div>
                  <h2 style={{ fontSize: '2.25rem', fontWeight: 700, color: C.breezeLight, marginBottom: '20px', lineHeight: '1.2', letterSpacing: '-0.02em' }}>
                    See the whole pipeline, not just the forecast call
                  </h2>
                  <p style={{ fontSize: '1.1rem', color: 'rgba(127,205,255,.65)', lineHeight: '1.7', marginBottom: '24px' }}>
                    Watch every active call, deal stage, and outcome update live. Coach reps in the moment instead of finding out a deal stalled three weeks after the fact.
                  </p>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    {[
                      'Live rep activity dashboard',
                      'Deal stage auto-updates from call outcomes',
                      'Listen, whisper, or barge on any live call',
                      'Rep leaderboard for calls and close rate',
          ...
          <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '0 2rem' }}>
            <div style={{
              ...
              <p style={{
                ...
                "Our reps used to spend half the day just figuring out who to call next. Now leads route and dial automatically. Our close rate is up 2x and nobody's chasing spreadsheets anymore."
              </p>
              <div style={{ fontWeight: 600, color: C.textDark, fontSize: '15px' }}>VP of Sales</div>
              <div style={{ color: C.textMid, fontSize: '13px', marginTop: '4px' }}>B2B Software Company</div>
      ...
      <section style={{ padding: '80px 0', background: C.foam }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '40px', flexWrap: 'wrap', marginBottom: '32px', opacity: 0.85 }}>
            {['Salesforce', 'HubSpot', 'Pipedrive'].map((stack, i) => (
          ...
          <p style={{ fontSize: '14px', color: C.textMid, maxWidth: '560px', margin: '0 auto' }}>
            Native API support for CRM sync and sales workflow automation.
          </p>
        </div>
      </section>
          ...
          <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem', textAlign: 'center' }}>
            <div style={{
              ...
              <h2 style={{ fontSize: 'clamp(2rem, 3.5vw, 2.75rem)', fontWeight: 700, color: C.white, marginBottom: '16px', letterSpacing: '-0.02em' }}>
                Equip your sales team today — free for 14 days
              </h2>
